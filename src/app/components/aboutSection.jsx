...
const TAB_DATA = [
    {
        ...
        content: (
            <ul className="education-list ">
                <li className="education-item"> <div className="degree"> Building Responsive Websites </div><div className="institution">Ensuring that my projects look great on all devices.</div></li>
                <li className="education-item"> <div className="degree">Collaborating on Projects: </div><div className="institution">Working closely with designers and back-end developers to bring ideas to life.</div></li>
    ...
    },
    {
        ...
        content: (
            <ul className="education-list">
                <li className="education-item"> <div className="institution">3 months of experience as an intern in web development.</div></li>
                <li className="education-item"> <div className="degree">Engineering of Technology and Electronic Center:</div>
                    <div className="institution">Basic/Advance C/C++/OOP & Project Courses
                        HTML, CSS, Bootstrap, JavaScript, jQuery & Project Courses</div>
                </li>
...
\                    <div className= "grid grid-cols-1 md:grid-cols-3 a gap-14 py-8 xl:gap-8">
                ...
                <Section>
                    <h2 className='text-5xl font-bold text-[#2f4156] mb-4'>So who i am ?</h2>
