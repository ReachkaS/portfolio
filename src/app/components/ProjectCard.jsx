...
<div>
    ...
    >
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-start lg:items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
